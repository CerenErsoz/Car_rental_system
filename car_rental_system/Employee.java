...
public class Employee {
    ...
    public int getRent_count_emp() {return rent_count_emp;}
    public void setRent_count_emp(int rent_count_emp) {this.rent_count_emp = rent_count_emp;}
    ...
    public boolean isEmp_available() {return emp_available;}
    public void setEmp_available(boolean emp_available) {this.emp_available = emp_available;}
