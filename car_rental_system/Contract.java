public class Contract {
    ...
    public Contract(int employee_id, int customer_id, int car_id, Date start_date, Date end_date,int contract_id,int office_id,boolean available){
    ...
    public void display() {
        System.out.println("  "+this.contract_id+".Contract: "+"Employee"+this.employee_id+";Customer"+this.customer_id+";Car"+this.car_id+";"+this.start_date.display()+";"+this.end_date.display());
    }
