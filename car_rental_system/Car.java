...
public class Car {
    ...
    public int getProfit() {return profit;}
   	...
   	public int getCar_maintenance2() {return car_maintenance2;}
    public void setCar_maintenance2(int car_maintenance2) {this.car_maintenance2 = car_maintenance2;}
    public int getRent_count() {return rent_count_car;}
    public void setRent_count(int rent_count) {this.rent_count_car = rent_count;}
    public int getCar_maintenance() {return car_maintenance;}
    public void setCar_maintenance(int car_maintenance) {this.car_maintenance = car_maintenance;}
    ...
    public boolean getCarAvailabe() {return car_availabe;}
    public void setCarAvailabe(boolean car_availabe) { this.car_availabe = car_availabe; }
}
