...
public class CarRequest {
	...
	public CarRequest(int office_id, int customer_id, String brand, String model, String clas, Date start_date, Date end_date,int car_request_id) {
	...
	public int getCar_request_id() {return car_request_id;}
	public void setCar_request_id(int car_request_id) {this.car_request_id = car_request_id;}
	public int getOffice_id() {return office_id;}
	public void setOffice_id(int office_id) {this.office_id = office_id;}
	public int getCustomer_id() {return customer_id;}
	public void setCustomer_id(int cutomer_id) {this.customer_id = cutomer_id;}
